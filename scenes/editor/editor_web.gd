...
#onready var NativeSelectFolderDialog := $NativeDialogs/SelectFolder
#onready var GodotOpenFileDialog := $GodotDialogs/OpenFile
#onready var GodotSaveFileDialog := $GodotDialogs/SaveFile
#onready var OverwriteDialog := $GodotDialogs/Overwrite
...
#func _on_resized():
#	if GodotOpenFileDialog != null:
#		GodotOpenFileDialog.rect_global_position = (rect_size / 2) - (GodotOpenFileDialog.rect_size / 2)
#	if OverwriteDialog != null:
#		OverwriteDialog.rect_global_position = (rect_size / 2) - (OverwriteDialog.rect_size / 2)
